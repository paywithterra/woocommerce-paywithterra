 ...
 * Plugin URI: https://paywithterra.com
...
function paywithterra_init_gateway_class() {
	...
	class WC_PaywithTerra_Gateway extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->method_description = 'Direct payments in Terra blockchain'; // displayed on the options page
		...
		protected function get_or_create_remote_order_uuid( $order_id ) {
			...
			if (! in_array((int) $client->getLastResponseCode(), [200, 201]) ) {
